...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
    ...
    private Object doCreateBean(String beanName, BeanDefinition beanDefinition, Object[] args) {
        ...
        try {
            ...
            //  step-14 给bean填充属性之前，允许BeanPostProcessor修改属性值
    ...
    protected Object getEarlyBeanReference(
        ...
        System.out.println("提前暴露bean【" + beanName + "】");
        return exposedObject;
    }

    /**
     * bean实例化后对于返回false的对象，不再执行后续设置bean对象属性的操作
     *
     * @param beanName
     * @param bean
     * @return
        ...
        for (BeanPostProcessor beanPostProcessor : getBeanPostProcessors()) {
            if (beanPostProcessor instanceof InstantiationAwareBeanPostProcessor) {
                InstantiationAwareBeanPostProcessor instantiationAwareBeanPostProcessor =
                        (InstantiationAwareBeanPostProcessor) beanPostProcessor;
                if (!instantiationAwareBeanPostProcessor.postProcessAfterInstantiation(
                        bean, beanName)) {
    ...
    protected void applyPropertyValues(
        ...
        try {
            ...
            throw new BeansException("设置属性值时出错: [" + beanName + "]");
        }
    }
